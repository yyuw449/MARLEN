...
class Scenario(BaseScenario):
    ...
    def reset_world(self, world):
        #print("reset self.iter_num:", self.iter_num)
        world.num_steps = 0
        # if self.iter_num != 4:
        #     self.iter_num += 1
        # else:
    ...
    def benchmark_data(self, agent, world):
        ...
        # print("here bench")
        # print("bench self.iter_num:", self.iter_num)
        rew = 0.0
        dists = []
        ...
        for i, land in enumerate(world.landmarks):
            for j, a in enumerate(world.agents):
                if self.is_collision(a, land):
                    ...
                    #         win_agents.append(a)
                    #         break
                    # elif self.iter_num == 2:
                    #     if(i==(j+2)%5):
                    #         win_agents.append(a)
                    #         break
                    # elif self.iter_num == 3:
                    #     if(i==(j+3)%5):
                    #         win_agents.append(a)
                    #         break
                    # elif self.iter_num == 4:
                    #     if(i==(j+4)%5):
                    #         win_agents.append(a)
                    #         break
    ...
    def reward(self, agent, world):
        ...
        # print("here reward")
        # print("reward self.iter_num:", self.iter_num)
        rew = 0.0
        if world.rew_shaping:
            ...
            for i, lm in enumerate(world.landmarks):
                ...
                # elif self.iter_num == 2:
                #    
                #     map_d = {0: 3, 1: 4, 2: 0, 3:1, 4:2}
                #     map_d = {0: 2, 1: 3, 2: 4, 3:0, 4:1}
                #     map_d = {0: 1, 1: 2, 2: 3, 3:4, 4:0}
                #     min_dist, min_idx = self.get_min_index(dists)
                #     if map_d[i] != min_idx:
                #         _rew = min_dist + 2
                #     else:
