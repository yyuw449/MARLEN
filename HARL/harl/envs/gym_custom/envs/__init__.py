from harl.envs.gym_custom.envs.registration import (
    registry,
    register,
    make,
    spec,
...
register(
    id="HalfCheetah-v2",
    entry_point="harl.envs.gym_custom.envs.mujoco:HalfCheetahEnv",
    max_episode_steps=1000,
...
register(
    id="HalfCheetah-v3",
    entry_point="harl.envs.gym_custom.envs.mujoco.half_cheetah_v3:HalfCheetahEnv",
    max_episode_steps=1000,
    reward_threshold=4800.0,
)
...
register(
    id="Hopper-v2",
    entry_point="harl.envs.gym_custom.envs.mujoco:HopperEnv",
    max_episode_steps=1000,
...
register(
    id="Hopper-v3",
    entry_point="harl.envs.gym_custom.envs.mujoco.hopper_v3:HopperEnv",
    max_episode_steps=1000,
    reward_threshold=3800.0,
)
...
register(
    id="Walker2d-v2",
    max_episode_steps=1000,
    entry_point="harl.envs.gym_custom.envs.mujoco:Walker2dEnv",
)

register(
    id="Walker2d-v3",
    max_episode_steps=1000,
    entry_point="harl.envs.gym_custom.envs.mujoco.walker2d_v3:Walker2dEnv",
)

register(
    id="Ant-v2",
    entry_point="harl.envs.gym_custom.envs.mujoco:AntEnv",
    max_episode_steps=1000,
...
register(
    id="Ant-v3",
    entry_point="harl.envs.gym_custom.envs.mujoco.ant_v3:AntEnv",
    max_episode_steps=1000,
    reward_threshold=6000.0,
)
...
register(
    id="Humanoid-v2",
    entry_point="harl.envs.gym_custom.envs.mujoco:HumanoidEnv",
    max_episode_steps=1000,
)

register(
    id="Humanoid-v3",
    entry_point="harl.envs.gym_custom.envs.mujoco.humanoid_v3:HumanoidEnv",
    max_episode_steps=1000,
)
