...
class MultipleCombatEnv(BaseEnv):
    ...
    def step(self, action: np.ndarray) -> Tuple[np.ndarray, np.ndarray, np.ndarray, dict]:
        ...
        """
        # print('reached step LAG')
        self.current_step += 1
        info = {"current_step": self.current_step}
        # print('type self.task : ',type(self.task)) --  <class 'harl.envs.lag.JSBSim.tasks.multiplecombat_vs_baseline_task.HierarchicalMultipleCombatShootVsBaselineTask'>
        # exit(1)
        # apply actions
