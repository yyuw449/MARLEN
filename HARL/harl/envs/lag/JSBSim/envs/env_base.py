...
from harl.envs.gym_custom.utils import seeding
import numpy as np
from typing import Dict, Any, Tuple
from ..core.simulatior import AircraftSimulator, BaseSimulator
from ..tasks.task_base import BaseTask
from ..utils.utils import parse_config
from harl.envs.gym_custom.core import Env
...
class BaseEnv(Env):
    ...
    @property
    def observation_space(self) -> harl.envs.gym_custom.Space:
        return self.task.observation_space

    @property
    def action_space(self) -> harl.envs.gym_custom.Space:
