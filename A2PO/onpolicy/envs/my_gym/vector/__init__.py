...
from onpolicy.envs.my_gym.vector.async_vector_env import AsyncVectorEnv
from onpolicy.envs.my_gym.vector.sync_vector_env import SyncVectorEnv
from onpolicy.envs.my_gym.vector.vector_env import VectorEnv, VectorEnvWrapper
...
def make(id, num_envs=1, asynchronous=True, wrappers=None, **kwargs):
    ...
    array([[-0.04456399,  0.04653909,  0.01326909, -0.02099827],
          ...
          dtype=float32)
    """
    from onpolicy.envs.my_gym.envs import make as make_
