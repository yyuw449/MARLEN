...
from onpolicy.envs.my_gym.spaces import Space, Tuple, Dict
from onpolicy.envs.my_gym.vector.utils.spaces import _BaseGymSpaces
...
def create_empty_array(space, n=1, fn=np.zeros):
    ...
    Example
    -------
    >>> from onpolicy.envs.my_gym.spaces import Box, Dict
    >>> space = Dict({
