...
from onpolicy.envs.my_gym.envs.box2d.car_dynamics import Car
from onpolicy.envs.my_gym.utils import seeding, EzPickle
from onpolicy.envs import my_gym
...
class CarRacing(my_gym.Env, EzPickle):
    ...
    def render(self, mode="human"):
        ...
        if self.viewer is None:
            from onpolicy.envs.my_gym.envs.classic_control import rendering
