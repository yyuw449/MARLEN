    ...
    def get_obs_agent(self, agent_id):
        ...
        if unit.health > 0:  # otherwise dead, return all zeros
            ...
            for e_id, e_unit in self.enemies.items():
                ...
                e_x += var
                e_y += var
                #print("v_e_x:", np.random.normal(
                #0, self.up[self.iter_num] if self.iter == 1 else self.down[self.iter_num]
                #))
                #print("v_e_y:", np.random.normal(
                #0, self.up[self.iter_num] if self.iter == 1 else self.down[self.iter_num]
                #))
                print("e_x:", e_x)
                print("e_y:", e_y)
