...
class StarCraft2Env(MultiAgentEnv):
    ...
    def __init__(
        ...
        self.iter = -1
        #self.iter_num = 0
        #self.up = np.linspace(1, 4, num=480000)
        #self.down = np.linspace(4, 1, num=480000)
        #self.en_x = []
        #self.en_y = []
    ...
    def reset(self):
        ...
        """
        #if(self.iter_num !=0):
         #   print("self.iter_num:", self.iter_num)
        self.iter *= -1
        #self.iter_num = 0
        #if (self.en_x!=[]):
         #   print("max x:", max(self.en_x))
          #  print("min x:", min(self.en_x))
        #if (self.en_y!=[]):
         #   print("max y:", max(self.en_y))
          #  print("min y:", min(self.en_y))
        #self.en_x=[]
        #self.en_y=[]
        #if(self._episode_steps !=0):
         #   print("_episode_steps:", self._episode_steps)
        #print("_episode_count:", self._episode_count)
    ...
    def get_agent_action_heuristic(self, a_id, action):
        ...
        if unit.unit_type == self.medivac_id:
            if (target is None or self.agents[target].health == 0 or self.agents[target].health == self.agents[target].health_max):
    ...
    def get_obs_agent(self, agent_id):
        ...
        if unit.health > 0:  # otherwise dead, return all zeros
            ...
            for e_id, e_unit in self.enemies.items():
                e_x = e_unit.pos.x
                #self.en_x.append(e_x)
                e_y = e_unit.pos.y
                #self.en_y.append(e_y)
                print("e_x:", e_x)
                print("e_y:", e_y)
                ...
                print("e_x:", e_x)
                print("e_y:", e_y)
                #self.iter_num += 1 #sawtooth stochastic variance
